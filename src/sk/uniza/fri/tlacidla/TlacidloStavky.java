 ...
 * @author jakub
 */
public class TlacidloStavky implements ITlacidlo {
    /**
    ...
    public boolean obsahujeSuradnice(int x, int y) {
        return x >= 200 && x < 300 && y >= 487 && y < 587;
    }
    /**
    ...
    public String getPopis() {
        return "Tlačidlo ktoré po kliknutí otvorí ponuku s jednotlivými stávkami";
    }
}
